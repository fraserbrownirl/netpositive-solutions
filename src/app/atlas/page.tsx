...
export default function AtlasDirectory() {
  ...
  return <main className="atlas-page">
    <header className="atlas-topbar"><a className="atlas-brand" href="/"><span className="brand-mark"><Sprout size={18} /></span><span>NET-POSITIVE<br /><b>ATLAS DIRECTORY</b></span></a><a className="atlas-back" href="/"><ArrowLeft size={15} /> Back to Net-Positive</a></header>
    <section className="atlas-hero"><div><p className="kicker">Public directory / research tool</p><h1>505 assets.<br /><em>One working map.</em></h1><p>This searchable directory is a captured research snapshot of public ecological, climate, energy, land and impact assets. It is kept as a research tool for understanding prior art — not as an endorsement, investment list or claim that every listing is restoration.</p></div><div className="atlas-count"><strong>505</strong><span>public listings</span><small>Snapshot captured<br />14 Sep 2026 UTC</small></div></section>
    ...
    <footer className="atlas-footer"><span>Source: <a href="https://www.regenatlas.xyz/" target="_blank" rel="noreferrer">regenatlas.xyz</a></span><span>Third-party snapshot · Research use only · Not investment advice</span><a href="/">Back to Net-Positive Solutions ↑</a></footer>
  </main>;
}
